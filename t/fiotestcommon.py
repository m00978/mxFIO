...
class Requirements():
    ...
    def __init__(self, fio_root, args):
        ...
        if Requirements._linux:
            ...
            if not success:
                ...
                Requirements._cuda = "CONFIG_CUDA" in contents
                Requirements._libcufile = "CONFIG_LIBCUFILE" in contents
    ...
    def cuda(cls):
        ...
        return Requirements._cuda, "CUDA support required"

    @classmethod
    def libcufile(cls):
        """Is LIBCUFILE support available?"""
        return Requirements._libcufile, "libcufile support required"
